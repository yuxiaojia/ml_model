...
export CUTLASS_DIR="${CUTLASS_DIR:-/nethome/yjia305/USERSCRATCH/cutlass_fresh}"
export STANDALONE_CUTLASS_DIR="${STANDALONE_CUTLASS_DIR:-${CUTLASS_DIR}}"
export STANDALONE_CUTLASS_BUILD_DIR="${STANDALONE_CUTLASS_BUILD_DIR:-/tmp/ml_bench_cutlass_fresh_standalone_conv_build}"
export PYTHONPATH="${root_dir}/custom_conv_fresh:${PYTHONPATH:-}"

cd "${root_dir}/custom_conv_fresh"
python "${script}"
