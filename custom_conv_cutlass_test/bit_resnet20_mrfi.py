#!/usr/bin/env python3
"""
ResNet-20 CIFAR-100 Evaluation with MRFI Bit Flip Fault Injection (Position 30)
"""
...
def evaluate_accuracy_with_fi(model, data_loader, device, target_layer, bit_count, bit_position=30, seed=42):
    """Evaluate top-1 accuracy with MRFI bit flip fault injection."""
    model.eval()

    print(f"\nApplying MRFI bit flip fault injection:")
...
def main() -> None:
    parser = argparse.ArgumentParser(description='ResNet-20 CIFAR-100 with MRFI Bit Flip')
    ...
    print("ResNet-20 CIFAR-100 with MRFI Bit Flip (Position 30)")
    print("=" * 60)
