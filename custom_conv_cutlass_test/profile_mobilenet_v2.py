#!/usr/bin/env python3
"""
MobileNetV2 CIFAR-100 Profiling (resnet.py style)
...
print("MobileNetV2 x1.0 CIFAR-100 Profiling")
print("=" * 60)
...
with torch.no_grad():
    ...
    # Save boundaries
    with open("mobilenet_boundary.txt", "w") as bf:
    ...
    print(f"\n✓ Kernel boundaries saved to: mobilenet_boundary.txt")
