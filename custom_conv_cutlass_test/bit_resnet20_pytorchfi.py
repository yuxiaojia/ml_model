#!/usr/bin/env python3
"""
ResNet-20 CIFAR-100 Evaluation with PyTorchFI Bit Flip Fault Injection (Position 30)
"""
...
def main() -> None:
    parser = argparse.ArgumentParser(description='ResNet-20 CIFAR-100 with PyTorchFI Bit Flip')
    ...
    print("ResNet-20 CIFAR-100 with PyTorchFI Bit Flip (Position 30)")
    print("=" * 60)
