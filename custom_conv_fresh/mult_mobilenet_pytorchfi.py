#!/usr/bin/env python3
"""
MobileNetV2 CIFAR-100 Evaluation with PyTorchFI Extreme Mode Fault Injection
...
def main() -> None:
    parser = argparse.ArgumentParser(description='MobileNetV2 CIFAR-100 with PyTorchFI')
    parser.add_argument('--layer', type=str, default="features.0.0", help='Target layer for fault injection')
    ...
    print("MobileNetV2 x1.0 CIFAR-100 with PyTorchFI")
    print("=" * 60)
